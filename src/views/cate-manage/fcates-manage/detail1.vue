...
const rules = reactive<FormRules>({
  ...
  icon: [
    { required: true, message: '请输入xicons图标名称', trigger: 'blur' },
...
watchEffect(() => {
  ruleForm.fcatename = data.editFormData.fcatename
  ruleForm.icon = data.editFormData.icon
  ...
  <el-dialog v-model="dialogFormVisibleC" :title="title" width="75%">
    <div class="dialog-detail">
      ...
      >
        ...
        <el-form-item label="iconpark-icon图标名称" prop="icon">
